...
!(function (t, r) {
  "object" == typeof exports && "object" == typeof module
    ? (module.exports = r(require("matter-js")))
    : "function" == typeof define && define.amd
    ? define(["matter-js"], r)
    : "object" == typeof exports
    ? (exports.MatterAttractors = r(require("matter-js")))
    : (t.MatterAttractors = r(t.Matter));
})(this, function (t) {
  return (function (t) {
    function r(o) {
      ...
      var o = e(0),
        n = {
          ...
          Engine: {
            update: function (t) {
              for (
                var r = t.world, e = o.Composite.allBodies(r), n = 0;
                n < e.length;
                n += 1
              ) {
                var i = e[n],
                ...
                if (a && a.length > 0)
                  for (var s = n + 1; s < e.length; s += 1)
                    for (var u = e[s], c = 0; c < a.length; c += 1) {
                      var p = a[c],
                        f = p;
                      o.Common.isFunction(p) && (f = p(i, u)),
                        f && o.Body.applyForce(u, u.position, f);
                    }
              }
            },
          },
          Attractors: {
            ...
            gravity: function (t, r) {
              var e = o.Vector.sub(r.position, t.position),
                ...
                u = o.Vector.mult(a, s);
              o.Body.applyForce(t, t.position, o.Vector.neg(u)),
                o.Body.applyForce(r, r.position, u);
            },
          },
        };
